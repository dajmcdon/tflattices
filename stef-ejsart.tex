...
% \begin{figure}
%   \centering
%   \includegraphics[width=.9\textwidth]{toronto_densities.pdf}
%   \caption{Density estimates for temperatures ($x$-axis, in degrees Celsius) in
%     Toronto in the 1960s and 2000s 
%     (winter and summer months separately). Consistent with
%     \autoref{fig:globes}, the mean
%     increases over the period while the standard deviation decreases, resulting
%     in the loss of ``colder'' days. This phenomenon is most pronounced in the
%     winter.}
%   \label{fig:toronto-densities}
% \end{figure}
